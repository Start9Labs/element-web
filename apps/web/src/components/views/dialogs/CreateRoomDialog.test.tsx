...
describe("<CreateRoomDialog />", () => {
    ...
    beforeEach(() => {
        mockClient = getMockClientWithEventEmitter({
            ...
            getRoomIdForAlias: vi.fn().mockRejectedValue(new MatrixError({ errcode: "M_NOT_FOUND" })),
        });
    ...
    const getComponent = (props = {}) => render(<CreateRoomDialog onFinished={vi.fn()} {...props} />);
    ...
    describe("for a private room", () => {
        ...
        it("should render not the advanced options when UI.advancedSettings is disabled", async () => {
            vi.spyOn(SettingsStore, "getValue").mockImplementation((setting) => setting !== UIFeature.AdvancedSettings);
